...
Warning: A bug in haxe SVN seems to mess extraParams.hxml multiple -swf-lib, you may have to add **-swf-lib Away3d.swf** to your compilation arguments. The bug will soon be resolved (bug not filled yet).